package com.maxipago.checkoutexample;
...
public class CollectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DataCollector dataCollector = com.maxipago.api.DataCollector.getInstance();
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            public void run() {
                dataCollector.collectForSession(deviceSessionID, new com.maxipago.api.DataCollector.CompletionHandler() {
                    @Override
