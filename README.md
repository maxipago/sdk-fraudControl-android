...
maxiPago's SDK for Android helps integrate Kount's fraud fighting solution into
your Android app.
...
Download the [maxiPago fraudControl! android sdk] (https://github.com/maxipago/sdk-fraudControl-android/) and unzip the file in a
folder separate from your project

-   Copy the JAR file in the MaxiPagoDataCollector folder into the **libs** folder of your app
...
``` 
import com.maxipago.api.DataCollector;
